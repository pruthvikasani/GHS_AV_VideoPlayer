...
public class TeluguVideo extends AppCompatActivity {

    private DownloadManager downloadManager;
    public static String videoName= "Telugu";

    public static Uri TeluguUri = Uri.parse("https://drive.google.com/uc?authuser=0&id=15gaZgVViO0jIccwQ15PBxwFYlg5ZiCU-&export=download");
    public static String download_title = "TGH_Telugu Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telugu_video);
        ...
        TeluguVideo.this.getSupportActionBar().setTitle("Telugu Video");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TeluguVideo.this,MainActivity.class));
                finish();
            }
        });
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if(list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(TeluguVideo.this)
...
//            Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/"+videoName+".mp4");
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent videoActivity = new Intent(TeluguVideo.this,VideoPlayerActivity.class).putExtra("from","telugu");
            ...
            Toast.makeText(TeluguVideo.this,"No file exists",Toast.LENGTH_LONG).show();
    ...
    public AlertDialog.Builder buildDialog2(Context c) {
        ...
        builder.setPositiveButton("DOWNLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!isConnected(TeluguVideo.this))buildDialog(TeluguVideo.this).show();
                else {
                    downloadLayout = findViewById(R.id.downloadLayout);
                    downloadLayout.setVisibility(View.VISIBLE);
                    downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
//                Uri uri = Uri.parse("https://www.rmp-streaming.com/media/bbb-360p.mp4");
                    Uri uri = Uri.parse("https://drive.google.com/uc?authuser=0&id=15gaZgVViO0jIccwQ15PBxwFYlg5ZiCU-&export=download");
                    DownloadManager.Request request = new DownloadManager.Request(uri);

                    request.setTitle("TGH_Telugu Video");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(TeluguVideo.this,MainActivity.class);
