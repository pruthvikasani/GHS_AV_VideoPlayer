...
public class MalayalamVideo extends AppCompatActivity {

    private DownloadManager downloadManager;
    public static String videoName= "Malayalam";

    public static Uri MalayalamUri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1mgVC8q2AgGOy0_0wLoO5XkV8vcX1ZCsG&export=download");
    public static String download_title = "TGH_Malayalam Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malayalam_video);
        ...
        MalayalamVideo.this.getSupportActionBar().setTitle("Malayalam Video");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MalayalamVideo.this,MainActivity.class));
                finish();
            }
        });
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if(list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(MalayalamVideo.this)
...
//            Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/"+videoName+".mp4");
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent videoActivity = new Intent(MalayalamVideo.this,VideoPlayerActivity.class).putExtra("from","malayalam");
            ...
            Toast.makeText(MalayalamVideo.this,"No file exists",Toast.LENGTH_LONG).show();
    ...
    public AlertDialog.Builder buildDialog2(Context c) {
        ...
        builder.setPositiveButton("DOWNLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!isConnected(MalayalamVideo.this)) buildDialog(MalayalamVideo.this).show();
                else {
                    downloadLayout = findViewById(R.id.downloadLayout);
                    downloadLayout.setVisibility(View.VISIBLE);
                    downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
//                Uri uri = Uri.parse("https://www.rmp-streaming.com/media/bbb-360p.mp4");
                    Uri uri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1mgVC8q2AgGOy0_0wLoO5XkV8vcX1ZCsG&export=download");
                    DownloadManager.Request request = new DownloadManager.Request(uri);

                    request.setTitle("TGH_Malayalam Video");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(MalayalamVideo.this,MainActivity.class);
