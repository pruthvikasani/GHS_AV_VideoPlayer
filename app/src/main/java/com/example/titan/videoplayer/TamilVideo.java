...
public class TamilVideo extends AppCompatActivity {

    private DownloadManager downloadManager;
    public static String videoName= "Tamil";

    public static Uri TamilUri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1FdkfMv4HOB72Har83VuoVxCM5tTBAkJP&export=download");
    public static String download_title = "TGH_Tamil Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_video);
        ...
        TamilVideo.this.getSupportActionBar().setTitle("Tamil Video");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TamilVideo.this,MainActivity.class));
                finish();
            }
        });
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if(list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(TamilVideo.this)
...
//            Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/"+videoName+".mp4");
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent videoActivity = new Intent(TamilVideo.this,VideoPlayerActivity.class).putExtra("from","tamil");
            ...
            Toast.makeText(TamilVideo.this,"No file exists",Toast.LENGTH_LONG).show();
    ...
    public AlertDialog.Builder buildDialog2(Context c) {
        ...
        builder.setPositiveButton("DOWNLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!isConnected(TamilVideo.this)) buildDialog(TamilVideo.this).show();
                else {
                    downloadLayout = findViewById(R.id.downloadLayout);
                    downloadLayout.setVisibility(View.VISIBLE);
                    downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
//                Uri uri = Uri.parse("https://www.rmp-streaming.com/media/bbb-360p.mp4");
                    Uri uri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1FdkfMv4HOB72Har83VuoVxCM5tTBAkJP&export=download");
                    DownloadManager.Request request = new DownloadManager.Request(uri);

                    request.setTitle("TGH_Tamil Video");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(TamilVideo.this,MainActivity.class);
