...
public class KannadaVideo extends AppCompatActivity {

    private DownloadManager downloadManager;
    public static String videoName= "Kannada";

    public static Uri KannadaUri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1mgVC8q2AgGOy0_0wLoO5XkV8vcX1ZCsG&export=download");
    public static String download_title = "TGH_Kannada Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kannada_video);
        ...
        KannadaVideo.this.getSupportActionBar().setTitle("Kannada Video");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KannadaVideo.this,MainActivity.class));
                finish();
            }
        });
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if(list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(KannadaVideo.this)
...
//            Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/"+videoName+".mp4");
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent videoActivity = new Intent(KannadaVideo.this,VideoPlayerActivity.class).putExtra("from","kannada");
            ...
            Toast.makeText(KannadaVideo.this,"No file exists",Toast.LENGTH_LONG).show();
    ...
    public AlertDialog.Builder buildDialog2(Context c) {
        ...
        builder.setPositiveButton("DOWNLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if( !isConnected(KannadaVideo.this)) buildDialog(KannadaVideo.this).show();
                else {
                    downloadLayout = findViewById(R.id.downloadLayout);
...
//                Uri uri = Uri.parse("https://www.rmp-streaming.com/media/bbb-360p.mp4");
                    ...
                    request.setTitle("TGH_Kannada Video");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(KannadaVideo.this,MainActivity.class);
