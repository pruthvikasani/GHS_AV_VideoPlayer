...
public class MaratiVideo extends AppCompatActivity {

    private DownloadManager downloadManager;
    public static String videoName= "Marati";

    public static Uri MaratiUri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1SsFq-2W3W_YfJc11DuxbFWoFo7MxXCxN&export=download");
    public static String download_title = "TGH_Marati Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaratiVideo.this.getSupportActionBar().setTitle("Marati Video");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MaratiVideo.this,MainActivity.class));
                finish();
            }
        });
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if(list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(MaratiVideo.this)
...
//            Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/"+videoName+".mp4");
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent videoActivity = new Intent(MaratiVideo.this,VideoPlayerActivity.class).putExtra("from","marati");
            ...
            Toast.makeText(MaratiVideo.this,"No file exists",Toast.LENGTH_LONG).show();
    ...
    public AlertDialog.Builder buildDialog2(Context c) {
        ...
        builder.setPositiveButton("DOWNLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!isConnected(MaratiVideo.this)) buildDialog(MaratiVideo.this).show();
                else {
                    downloadLayout = findViewById(R.id.downloadLayout);
                    downloadLayout.setVisibility(View.VISIBLE);
                    downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
//                Uri uri = Uri.parse("https://www.rmp-streaming.com/media/bbb-360p.mp4");
                    Uri uri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1SsFq-2W3W_YfJc11DuxbFWoFo7MxXCxN&export=download");
                    DownloadManager.Request request = new DownloadManager.Request(uri);

                    request.setTitle("TGH_Marati Video");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(MaratiVideo.this,MainActivity.class);
