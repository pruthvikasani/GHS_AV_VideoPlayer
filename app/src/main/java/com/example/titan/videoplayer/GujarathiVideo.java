...
public class GujarathiVideo extends AppCompatActivity {

    private DownloadManager downloadManager;
    public static String videoName= "Gujarathi";

    public static Uri GujarathiUri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1Pc2noM_wJvjQtGJNlfrWiHbvMP3VJ6q5&export=download");
    public static String download_title = "TGH_Gujarathi Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gujarathi_video);
        ...
        GujarathiVideo.this.getSupportActionBar().setTitle("Gujarathi Video");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GujarathiVideo.this,MainActivity.class));
                finish();
            }
        });
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if(list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(GujarathiVideo.this)
...
//            Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/"+videoName+".mp4");
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent videoActivity = new Intent(GujarathiVideo.this,VideoPlayerActivity.class).putExtra("from","gujarathi");
            ...
            Toast.makeText(GujarathiVideo.this,"No file exists",Toast.LENGTH_LONG).show();
    ...
    public AlertDialog.Builder buildDialog2(Context c) {
        ...
        builder.setPositiveButton("DOWNLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!isConnected(GujarathiVideo.this)) buildDialog(GujarathiVideo.this).show();
                else {
                    downloadLayout = findViewById(R.id.downloadLayout);
                    downloadLayout.setVisibility(View.VISIBLE);
                    downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
//                Uri uri = Uri.parse("https://www.rmp-streaming.com/media/bbb-360p.mp4");
                    Uri uri = Uri.parse("https://drive.google.com/uc?authuser=0&id=1Pc2noM_wJvjQtGJNlfrWiHbvMP3VJ6q5&export=download");
                    DownloadManager.Request request = new DownloadManager.Request(uri);

                    request.setTitle("TGH_Gujarathi Video");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(GujarathiVideo.this,MainActivity.class);
